...
`pto.tcolexpandmul` is part of the [Reduce And Expand](../../reduce-and-expand.md) instruction set.
...
void example_auto() {
  ...
  DstT dst;
  ColVecT src1;
  // Col-expand-mul: each column of dst = src0.col * src1.col_scalar
  TCOLEXPANDMUL(dst, src0, src1);
}
```
