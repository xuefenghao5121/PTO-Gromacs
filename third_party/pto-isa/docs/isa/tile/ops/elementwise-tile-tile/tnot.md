...
`pto.tnot` is part of the [Elementwise Tile Tile](../../elementwise-tile-tile.md) instruction set.
...
`TNOT` compiles to CCE vector instructions via the `TUnaryOp.hpp` performance model:
