                ...
                int maxC = INT32_MAX)
{
    ...
    auto stride3 =
        std::max(tensor.GetStride(pto::GlobalTensorDim::DIM_3), tensor.GetStride(pto::GlobalTensorDim::DIM_4));
    std::cout << name << ": " << tensor.GetShape(pto::GlobalTensorDim::DIM_0) << " x "
              << tensor.GetShape(pto::GlobalTensorDim::DIM_1) << " x " << tensor.GetShape(pto::GlobalTensorDim::DIM_2)
              << " x " << tensor.GetShape(pto::GlobalTensorDim::DIM_3) << " x "
