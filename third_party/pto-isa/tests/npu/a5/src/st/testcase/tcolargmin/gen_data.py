...
if __name__ == "__main__":
    case_params_list = [
        ...
        TColCMinParams("TCOLCMINTest.case21", np.int8, 1, 1, 256, 255),
        TColCMinParams("TCOLCMINTest.case22", np.int8, 16, 16, 128, 127),
        TColCMinParams("TCOLCMINTest.case23", np.int8, 16, 15, 256, 255),
        TColCMinParams("TCOLCMINTest.case31", np.uint8, 1, 1, 256, 255),
        TColCMinParams("TCOLCMINTest.case32", np.uint8, 16, 16, 128, 127),
        TColCMinParams("TCOLCMINTest.case33", np.uint8, 16, 15, 256, 255),
        TColCMinParams("TCOLCMINTest.case41", np.int16, 1, 1, 256, 255),
        TColCMinParams("TCOLCMINTest.case42", np.int16, 16, 16, 128, 127),
        TColCMinParams("TCOLCMINTest.case43", np.int16, 16, 15, 256, 255),
        ...
        TColCMinParams("TCOLCMINTest.case61", np.int32, 1, 1, 256, 255),
        TColCMinParams("TCOLCMINTest.case62", np.int32, 16, 16, 128, 127),
        TColCMinParams("TCOLCMINTest.case63", np.int32, 16, 15, 256, 255),
