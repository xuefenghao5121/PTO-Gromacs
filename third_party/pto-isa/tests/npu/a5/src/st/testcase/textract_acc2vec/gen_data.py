...
if __name__ == "__main__":
    ...
    case_params_list = [
        TMovParams(np.float16, np.float16, np.float32, 60, 127, 120, 0, 0, 0, 'ND', 512, False, False, True, None, 1,
                   0, 16, False, 64, 128),
        TMovParams(np.float16, np.float16, np.float16, 110, 100, 80, 0, 0, 0, 'ND', 512, False, False, True, None, 1,
                   5, 0, False, 120, 96),
        TMovParams(np.float16, np.float16, np.float32, 6, 7, 8, 0, 0, 0, 'ND', 512, False, False, True, None, 1,
                   2, 0, False, 10, 16),
        TMovParams(np.float16, np.float16, bfloat16, 111, 47, 96, 0, 0, 0, 'ND', 512, False, False, True, None, 1,
                   3, 32, False, 150, 160),
        ...
        TMovParams(np.int8, np.int8, np.float16, 60, 128, 32, 0, 0, 0, 'ND', 512, True, False, False, np.uint64, 1,
                   5, 0, False, 70, 96),
        TMovParams(np.int8, np.int8, bfloat16, 128, 64, 96, 0, 0, 0, 'ND', 512, True, False, False, np.uint64, 1,
                   0, 0, False, 128, 96),
        TMovParams(np.float32, np.float32, np.int8, 60, 128, 64, 0, 0, 0, 'ND', 512, True, False, True, np.uint64, 1,
                   7, 32, False, 80, 256),
        TMovParams(np.float32, np.float32, np.float16, 31, 128, 128, 0, 0, 0, 'ND', 512, True, False, True,
                np.uint64, 1, 0, 64, False, 40, 256),
