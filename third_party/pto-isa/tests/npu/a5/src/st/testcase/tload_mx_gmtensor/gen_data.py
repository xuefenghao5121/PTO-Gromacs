...
def update_golden(golden, param, tile_rows, tile_cols):
    ...
    c0_size = 2
    if (param.load_type == DataFormat['AND2ZZ'].value or
        param.load_type == DataFormat['ADN2ZZ'].value or
        param.load_type == DataFormat['AZZ2ZZ'].value):
    ...
    elif (param.load_type == DataFormat['BND2NN'].value or
          param.load_type == DataFormat['BDN2NN'].value or
          param.load_type == DataFormat['BNN2NN'].value):
...
def gen_golden_data(param):
    ...
    elif param.load_type == DataFormat['AZZ2ZZ'].value:
        x1_gm = np.tile(np.arange(whole_shape3)[:, np.newaxis], (1, whole_shape4)).astype(src_type)
        golden = np.zeros([tile_rows, tile_cols]).astype(src_type)  # L1中Tile大小
        min_m = min(valid_row, golden.shape[0])
        min_k = min(valid_col, golden.shape[1])
    ...
    elif param.load_type == DataFormat['BNN2NN'].value:
        x1_gm = np.tile(np.arange(whole_shape3)[:, np.newaxis], (1, whole_shape4)).astype(src_type)
        golden = np.zeros([tile_rows, tile_cols]).astype(src_type)  # L1中Tile大小
        min_m = min(valid_row, golden.shape[0])
        min_k = min(valid_col, golden.shape[1])
...
if __name__ == "__main__":
    ...
    case_params_list = [
        # for scaleA, K % 2 == 0
        # AND2ZZ
        TmatmulParams("TLOADMXTest.1_1_1_16_4_uint8_AND2ZZ", np.uint8, np.uint8, np.uint8, 1, 1, 1,
                      16, 4, 1, 1, 1, 16, 4, 16, 4, DataFormat['AND2ZZ'].value),
        ...
        TmatmulParams("TLOADMXTest.1_1_1_16_64_uint8_ADN2ZZ", np.uint8, np.uint8, np.uint8, 1, 1, 1,
                      16, 64, 1, 1, 1, 16, 64, 16, 64, DataFormat['ADN2ZZ'].value),
        TmatmulParams("TLOADMXTest.1_1_1_32_128_uint8_ADN2ZZ", np.uint8, np.uint8, np.uint8, 1, 1, 1,
                      32, 128, 1, 1, 1, 32, 128, 32, 128, DataFormat['ADN2ZZ'].value),
        TmatmulParams("TLOADMXTest.1_1_1_128_128_uint8_ADN2ZZ", np.uint8, np.uint8, np.uint8, 1, 1, 1,
                      27, 126, 1, 1, 1, 128, 128, 128, 128, DataFormat['ADN2ZZ'].value),
        ...
        # BND2NN
        TmatmulParams("TLOADMXTest.1_1_1_4_64_uint8_BND2NN", np.uint8, np.uint8, np.uint8, 1, 1, 1,
                      4, 64, 1, 1, 1, 4, 64, 4, 64, DataFormat['BND2NN'].value),
        TmatmulParams("TLOADMXTest.1_1_1_16_64_uint8_BND2NN", np.uint8, np.uint8, np.uint8, 1, 1, 1,
                      16, 64, 1, 1, 1, 16, 64, 16, 64, DataFormat['BND2NN'].value),
        ...
        TmatmulParams("TLOADMXTest.1_1_1_128_128_uint8_BND2NN", np.uint8, np.uint8, np.uint8, 1, 1, 1,
                      128, 128, 1, 1, 1, 128, 128, 128, 128, DataFormat['BND2NN'].value),
        ...
        # BDN2NN
        TmatmulParams("TLOADMXTest.1_1_1_4_64_uint8_BDN2NN", np.uint8, np.uint8, np.uint8, 1, 1, 1,
                      4, 64, 1, 1, 1, 4, 64, 4, 64, DataFormat['BDN2NN'].value),
        TmatmulParams("TLOADMXTest.1_1_1_16_64_uint8_BDN2NN", np.uint8, np.uint8, np.uint8, 1, 1, 1,
                      16, 64, 1, 1, 1, 16, 64, 16, 64, DataFormat['BDN2NN'].value),
        ...
        TmatmulParams("TLOADMXTest.1_1_1_128_128_uint8_BDN2NN", np.uint8, np.uint8, np.uint8, 1, 1, 1,
                      30, 127, 1, 1, 1, 128, 128, 128, 128, DataFormat['BDN2NN'].value),
        ...
        # AZZ2ZZ
        TmatmulParams("TLOADMXTest.1_1_1_16_4_uint8_AZZ2ZZ", np.uint8, np.uint8, np.uint8, 1, 1, 1,
                      16, 4, 1, 1, 1, 16, 4, 16, 4, DataFormat['AZZ2ZZ'].value),
        TmatmulParams("TLOADMXTest.1_1_1_128_96_uint8_AZZ2ZZ", np.uint8, np.uint8, np.uint8, 1, 1, 1,
                      80, 66, 1, 1, 1, 176, 80, 128, 96, DataFormat['AZZ2ZZ'].value),
        # BNN2NN
        TmatmulParams("TLOADMXTest.1_1_1_4_64_uint8_BNN2NN", np.uint8, np.uint8, np.uint8, 1, 1, 1,
                      4, 64, 1, 1, 1, 4, 64, 4, 64, DataFormat['BNN2NN'].value),
        TmatmulParams("TLOADMXTest.1_1_1_58_1088_uint8_BNN2NN", np.uint8, np.uint8, np.uint8, 1, 1, 1,
                      58, 1024, 1, 1, 1, 58, 1040, 58, 1088, DataFormat['BNN2NN'].value),
    ]
