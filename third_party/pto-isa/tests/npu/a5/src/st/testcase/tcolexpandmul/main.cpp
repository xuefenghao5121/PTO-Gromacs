...
class TColExpandMulTest : public testing::Test {
protected:
    void SetUp() override
    {}
...
void test_tcolexpandmul()
{
    ...
    launchTColExpandMul<T, dstRow, dstCol, src1Row, src1Col>(dstDevice, src0Device, src1Device, stream);
...
TEST_F(TColExpandMulTest, case_fp32_16_128_1_128)
{
    test_tcolexpandmul<float, 16, 128, 1, 128>();
}
TEST_F(TColExpandMulTest, case_fp32_32_32_1_32)
{
    test_tcolexpandmul<float, 32, 32, 1, 32>();
}
TEST_F(TColExpandMulTest, case_fp16_4_256_1_256)
{
    test_tcolexpandmul<aclFloat16, 4, 256, 1, 256>();
}
TEST_F(TColExpandMulTest, case_fp16_10_64_1_64)
{
    test_tcolexpandmul<aclFloat16, 10, 64, 1, 64>();
}
TEST_F(TColExpandMulTest, case_int32_16_32_1_32)
{
    test_tcolexpandmul<int32_t, 16, 32, 1, 32>();
}
TEST_F(TColExpandMulTest, case_int16_16_64_1_64)
{
    test_tcolexpandmul<int16_t, 16, 64, 1, 64>();
}
} // namespace TColExpandMulTest