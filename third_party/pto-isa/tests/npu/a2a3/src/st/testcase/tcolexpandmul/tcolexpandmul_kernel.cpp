...
#endif
    TCOLEXPANDMUL(dstTile, src0Tile, src1Tile);
#ifndef __PTO_AUTO__
...
template void launchTColExpandMul<aclFloat16, 10, 64, 1, 64>(aclFloat16 *out, aclFloat16 *src0, aclFloat16 *src1,
                                                             void *stream);
template void launchTColExpandMul<int32_t, 8, 32, 1, 32>(int32_t *out, int32_t *src0, int32_t *src1, void *stream);
template void launchTColExpandMul<int16_t, 8, 32, 1, 32>(int16_t *out, int16_t *src0, int16_t *src1, void *stream);
} // namespace TColExpandMulTest