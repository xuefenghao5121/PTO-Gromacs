...
def generate_case_name(param):
    ...
    return f"TRECIPTest.case_{dtype_str}_{param.global_row}x{param.global_col}"\
        f"_{param.tile_row}x{param.tile_col}_{param.valid_row}x{param.valid_col}_inPlace_{param.in_place}"
