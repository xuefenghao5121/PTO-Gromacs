...
TEST_F(TColExpandAddTest, case_fp32_16_128_1_128)
{
    test_tcolexpandadd<float, 16, 128, 1, 128>();
}
TEST_F(TColExpandAddTest, case_fp32_32_32_1_32)
{
    test_tcolexpandadd<float, 32, 32, 1, 32>();
}
TEST_F(TColExpandAddTest, case_fp16_4_256_1_256)
{
    test_tcolexpandadd<aclFloat16, 4, 256, 1, 256>();
}
TEST_F(TColExpandAddTest, case_fp16_10_64_1_64)
{
    test_tcolexpandadd<aclFloat16, 10, 64, 1, 64>();
}
TEST_F(TColExpandAddTest, case_int32_8_32_1_32)
{
    test_tcolexpandadd<int32_t, 8, 32, 1, 32>();
}
TEST_F(TColExpandAddTest, case_int16_8_32_1_32)
{
    test_tcolexpandadd<int16_t, 8, 32, 1, 32>();
}
} // namespace TColExpandAddTest