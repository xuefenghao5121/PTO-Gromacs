...
__global__ AICORE void runTRowArgMax(__gm__ TDst __out__ *out, __gm__ TSrc __in__ *src)
{
    ...
    TileDataTmp tmpTile(vRows, tmpTileW);
...
{
    runTRowArgMax<TDst, TSrc, dstTileH, dstTileW, srcTileH, srcTileW, tmpTileH, tmpTileW, vRows, vCols>
...
template void LaunchTRowArgMax<uint32_t, float, 8, 1, 8, 8, 1, 8, 8, 8>(uint32_t *out, float *src, void *stream);
template void LaunchTRowArgMax<uint32_t, float, 1024, 1, 1024, 8, 1, 8, 1024, 8>(uint32_t *out, float *src,
                                                                                 void *stream);
template void LaunchTRowArgMax<uint32_t, float, 16, 1, 13, 16, 1, 8, 13, 13>(uint32_t *out, float *src, void *stream);
template void LaunchTRowArgMax<uint32_t, float, 1024, 1, 1023, 24, 1, 8, 1023, 17>(uint32_t *out, float *src,
                                                                                   void *stream);
template void LaunchTRowArgMax<uint32_t, float, 8, 1, 8, 64, 1, 8, 8, 64>(uint32_t *out, float *src, void *stream);
template void LaunchTRowArgMax<uint32_t, float, 264, 1, 260, 64, 1, 8, 260, 64>(uint32_t *out, float *src,
                                                                                void *stream);
template void LaunchTRowArgMax<uint32_t, float, 64, 1, 32, 128, 32, 24, 32, 128>(uint32_t *out, float *src,
                                                                                 void *stream);
template void LaunchTRowArgMax<uint32_t, float, 8, 1, 3, 4096, 3, 192, 3, 4095>(uint32_t *out, float *src,
                                                                                void *stream);
template void LaunchTRowArgMax<uint32_t, float, 8, 1, 1, 16384, 1, 768, 1, 16381>(uint32_t *out, float *src,
                                                                                  void *stream);
template void LaunchTRowArgMaxHalf<uint32_t, 16, 1, 2, 16, 2, 16, 2, 16>(uint32_t *out, aclFloat16 *src, void *stream);
template void LaunchTRowArgMaxHalf<uint32_t, 16, 1, 13, 16, 1, 16, 13, 13>(uint32_t *out, aclFloat16 *src,
                                                                           void *stream);
template void LaunchTRowArgMaxHalf<uint32_t, 272, 1, 260, 64, 1, 16, 260, 64>(uint32_t *out, aclFloat16 *src,
                                                                              void *stream);
template void LaunchTRowArgMaxHalf<uint32_t, 272, 1, 260, 128, 1, 16, 260, 128>(uint32_t *out, aclFloat16 *src,
                                                                                void *stream);
template void LaunchTRowArgMaxHalf<uint32_t, 16, 1, 3, 8192, 3, 384, 3, 8191>(uint32_t *out, aclFloat16 *src,
                                                                              void *stream);
template void LaunchTRowArgMaxHalf<uint32_t, 16, 1, 1, 16384, 1, 768, 1, 16381>(uint32_t *out, aclFloat16 *src,
                                                                                void *stream);
...
template void LaunchTRowArgMaxHalf<int32_t, 16, 1, 13, 16, 1, 16, 13, 13>(int32_t *out, aclFloat16 *src, void *stream);
template void LaunchTRowArgMax<uint32_t, float, 3, 8, 3, 3480, 3, 168, 3, 3473>(uint32_t *out, float *src,
                                                                                void *stream);
template void LaunchTRowArgMax<uint32_t, float, 260, 8, 260, 64, 1, 8, 260, 64>(uint32_t *out, float *src,
                                                                                void *stream);
template void LaunchTRowArgMax<uint32_t, float, 1023, 8, 1023, 24, 1, 8, 1023, 17>(uint32_t *out, float *src,
                                                                                   void *stream);
template void LaunchTRowArgMax<uint32_t, float, 2, 8, 2, 16384, 2, 768, 2, 16381>(uint32_t *out, float *src,
                                                                                  void *stream);
template void LaunchTRowArgMaxHalf<uint32_t, 3, 16, 3, 3488, 3, 768, 3, 3473>(uint32_t *out, aclFloat16 *src,
                                                                              void *stream);
template void LaunchTRowArgMaxHalf<uint32_t, 260, 16, 260, 64, 1, 16, 260, 64>(uint32_t *out, aclFloat16 *src,
                                                                               void *stream);
template void LaunchTRowArgMaxHalf<uint32_t, 1023, 16, 1023, 32, 1, 16, 1023, 17>(uint32_t *out, aclFloat16 *src,
                                                                                  void *stream);
