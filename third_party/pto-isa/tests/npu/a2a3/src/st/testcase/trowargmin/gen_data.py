...
if __name__ == "__main__":
    ...
    case_list = [
        ...
        TRowArgMinValIdxParams(np.uint32, np.float32, 1024, 1, 1024, 1, 1023, 24, 1023, 8, 1023, 17),
        TRowArgMinValIdxParams(np.uint32, np.float32, 264, 1, 264, 1, 260, 64, 260, 8, 260, 64),
        TRowArgMinValIdxParams(np.uint32, np.float32, 8, 1, 8, 1, 3, 4096, 3, 192, 3, 4095),
        TRowArgMinValIdxParams(np.uint32, np.float32, 8, 1, 8, 1, 1, 16384, 1, 768, 1, 16381),
        TRowArgMinValIdxParams(np.uint16, np.float16, 272, 1, 272, 1, 260, 64, 260, 16, 260, 63),
        TRowArgMinValIdxParams(np.uint16, np.float16, 272, 1, 272, 1, 260, 128, 260, 16, 260, 127),
        TRowArgMinValIdxParams(np.uint16, np.float16, 16, 1, 16, 1, 3, 8192, 3, 384, 3, 8191),
        TRowArgMinValIdxParams(np.uint16, np.float16, 16, 1, 16, 1, 1, 16384, 1, 768, 1, 16381),
        TRowArgMinValIdxParams(np.uint16, np.float16, 16, 1, 16, 1, 1, 32768, 1, 768, 1, 32761),
        TRowArgMinValIdxParams(np.uint32, np.float32, 777, 8, 777, 8, 777, 24, 777, 8, 777, 17),
        TRowArgMinValIdxParams(np.uint32, np.float32, 784, 1, 777, 8, 777, 24, 777, 8, 777, 17),
        TRowArgMinValIdxParams(np.uint32, np.float32, 777, 8, 784, 1, 777, 24, 777, 8, 777, 17),
        TRowArgMinValIdxParams(np.uint32, np.float32, 3, 8, 3, 8, 3, 4096, 3, 192, 3, 4095),
        TRowArgMinValIdxParams(np.uint32, np.float32, 8, 1, 3, 8, 3, 4096, 3, 192, 3, 4095),
        TRowArgMinValIdxParams(np.uint32, np.float32, 3, 8, 8, 1, 3, 4096, 3, 192, 3, 4095),
        TRowArgMinValIdxParams(np.uint32, np.float32, 1, 8, 1, 8, 1, 16384, 1, 768, 1, 16381),
        TRowArgMinValIdxParams(np.uint32, np.float32, 8, 1, 1, 8, 1, 16384, 1, 768, 1, 16381),
        TRowArgMinValIdxParams(np.uint32, np.float32, 1, 8, 8, 1, 1, 16384, 1, 768, 1, 16381),
        TRowArgMinValIdxParams(np.uint16, np.float16, 777, 16, 777, 16, 777, 48, 777, 16, 777, 43),
        TRowArgMinValIdxParams(np.uint16, np.float16, 784, 1, 777, 16, 777, 48, 777, 16, 777, 43),
        TRowArgMinValIdxParams(np.uint16, np.float16, 777, 16, 784, 1, 777, 48, 777, 16, 777, 43),
        TRowArgMinValIdxParams(np.uint16, np.float16, 3, 16, 3, 16, 3, 4096, 3, 192, 3, 4095),
        TRowArgMinValIdxParams(np.uint16, np.float16, 16, 1, 3, 16, 3, 4096, 3, 192, 3, 4095),
        TRowArgMinValIdxParams(np.uint16, np.float16, 3, 16, 16, 1, 3, 4096, 3, 192, 3, 4095),
