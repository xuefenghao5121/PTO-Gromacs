...
protected:
    ...
    void Launch()
    {
        ...
        if constexpr (isHalf) {
            LaunchTRowArgMinHalf<TDst, dstTileH, dstTileW, srcTileH, srcTileW, tmpTileH, tmpTileW, vRows, vCols>(
                (TDst *)this->dstDevice, (TSrc *)this->srcDevice, this->stream);
        } else {
            LaunchTRowArgMin<TDst, TSrc, dstTileH, dstTileW, srcTileH, srcTileW, tmpTileH, tmpTileW, vRows, vCols>(
                (TDst *)this->dstDevice, (TSrc *)this->srcDevice, this->stream);
        }
    ...
    void Launch()
    {
        ...
        if constexpr (isHalf) {
            LaunchTRowArgMinHalf<TIdx, dstValTileH, dstValTileW, dstTileH, dstTileW, srcTileH, srcTileW, tmpTileH,
                                 tmpTileW, vRows, vCols>((TVal *)this->dstValDevice, (TIdx *)this->dstDevice,
                                                         (TVal *)this->srcDevice, this->stream);
        } else {
            LaunchTRowArgMin<TIdx, TVal, dstValTileH, dstValTileW, dstTileH, dstTileW, srcTileH, srcTileW, tmpTileH,
                             tmpTileW, vRows, vCols>((TVal *)this->dstValDevice, (TIdx *)this->dstDevice,
                                                     (TVal *)this->srcDevice, this->stream);
        }
...
TEST_F(TROWARGMINTest, case_uint32_float_8x1_8x8_1x8_8x8)
{
    this->Launch<uint32_t, float, 8, 1, 8, 8, 1, 8, 8, 8>();
}
TEST_F(TROWARGMINTest, case_uint32_float_1024x1_1024x8_1x8_1024x8)
{
    this->Launch<uint32_t, float, 1024, 1, 1024, 8, 1, 8, 1024, 8>();
}
TEST_F(TROWARGMINTest, case_uint32_float_16x1_13x16_1x8_13x13)
{
    this->Launch<uint32_t, float, 16, 1, 13, 16, 1, 8, 13, 13>();
}
TEST_F(TROWARGMINTest, case_uint32_float_1024x1_1023x24_1x8_1023x17)
{
    this->Launch<uint32_t, float, 1024, 1, 1023, 24, 1, 8, 1023, 17>();
}
TEST_F(TROWARGMINTest, case_uint32_float_8x1_8x64_1x8_8x64)
{
    this->Launch<uint32_t, float, 8, 1, 8, 64, 1, 8, 8, 64>();
}
TEST_F(TROWARGMINTest, case_uint32_float_264x1_260x64_1x8_260x64)
{
    this->Launch<uint32_t, float, 264, 1, 260, 64, 1, 8, 260, 64>();
}
TEST_F(TROWARGMINTest, case_uint32_float_64x1_32x128_32x24_32x128)
{
    this->Launch<uint32_t, float, 64, 1, 32, 128, 32, 24, 32, 128>();
}
TEST_F(TROWARGMINTest, case_uint32_float_8x1_3x4096_3x192_3x4095)
{
    this->Launch<uint32_t, float, 8, 1, 3, 4096, 3, 192, 3, 4095>();
}
TEST_F(TROWARGMINTest, case_uint32_float_8x1_1x16384_1x768_1x16381)
{
    this->Launch<uint32_t, float, 8, 1, 1, 16384, 1, 768, 1, 16381>();
}
TEST_F(TROWARGMINTest, case_uint32_half_16x1_2x16_2x16_2x16)
{
    this->Launch<uint32_t, aclFloat16, 16, 1, 2, 16, 2, 16, 2, 16, true>();
}
TEST_F(TROWARGMINTest, case_uint32_half_16x1_13x16_1x16_13x13)
{
    this->Launch<uint32_t, aclFloat16, 16, 1, 13, 16, 1, 16, 13, 13, true>();
}
TEST_F(TROWARGMINTest, case_uint32_half_272x1_260x64_1x16_260x64)
{
    this->Launch<uint32_t, aclFloat16, 272, 1, 260, 64, 1, 16, 260, 64, true>();
}
TEST_F(TROWARGMINTest, case_uint32_half_272x1_260x128_1x16_260x128)
{
    this->Launch<uint32_t, aclFloat16, 272, 1, 260, 128, 1, 16, 260, 128, true>();
}
TEST_F(TROWARGMINTest, case_uint32_half_16x1_3x8192_3x384_3x8191)
{
    this->Launch<uint32_t, aclFloat16, 16, 1, 3, 8192, 3, 384, 3, 8191, true>();
}
TEST_F(TROWARGMINTest, case_uint32_half_16x1_1x16384_1x768_1x16381)
{
    this->Launch<uint32_t, aclFloat16, 16, 1, 1, 16384, 1, 768, 1, 16381, true>();
}
TEST_F(TROWARGMINTest, case_uint32_half_16x1_1x32768_1x768_1x32761)
{
    this->Launch<uint32_t, aclFloat16, 16, 1, 1, 32768, 1, 768, 1, 32761, true>();
}
TEST_F(TROWARGMINTest, case_int32_float_16x1_13x16_1x8_13x13)
{
    this->Launch<int32_t, float, 16, 1, 13, 16, 1, 8, 13, 13>();
}
TEST_F(TROWARGMINTest, case_int32_half_16x1_13x16_1x16_13x13)
{
    this->Launch<int32_t, aclFloat16, 16, 1, 13, 16, 1, 16, 13, 13, true>();
}
TEST_F(TROWARGMINTest, case_uint32_float_3x8_3x3480_3x168_3x3473)
{
    this->Launch<uint32_t, float, 3, 8, 3, 3480, 3, 168, 3, 3473>();
}
TEST_F(TROWARGMINTest, case_uint32_float_260x8_260x64_1x8_260x64)
{
    this->Launch<uint32_t, float, 260, 8, 260, 64, 1, 8, 260, 64>();
}
TEST_F(TROWARGMINTest, case_uint32_float_1023x8_1023x24_1x8_1023x17)
{
    this->Launch<uint32_t, float, 1023, 8, 1023, 24, 1, 8, 1023, 17>();
}
TEST_F(TROWARGMINTest, case_uint32_float_2x8_2x16384_2x768_2x16381)
{
    this->Launch<uint32_t, float, 2, 8, 2, 16384, 2, 768, 2, 16381>();
}
TEST_F(TROWARGMINTest, case_uint32_half_3x16_3x3488_3x768_3x3473)
{
    this->Launch<uint32_t, aclFloat16, 3, 16, 3, 3488, 3, 768, 3, 3473, true>();
}
TEST_F(TROWARGMINTest, case_uint32_half_260x16_260x64_1x16_260x64)
{
    this->Launch<uint32_t, aclFloat16, 260, 16, 260, 64, 1, 16, 260, 64, true>();
}
TEST_F(TROWARGMINTest, case_uint32_half_1023x16_1023x32_1x16_1023x17)
{
    this->Launch<uint32_t, aclFloat16, 1023, 16, 1023, 32, 1, 16, 1023, 17, true>();
}
TEST_F(TROWARGMINTest, case_uint32_half_2x16_2x32768_2x768_2x32761)
{
    this->Launch<uint32_t, aclFloat16, 2, 16, 2, 32768, 2, 768, 2, 32761, true>();
}
TEST_F(TROWARGMINTest, case_uint32_float_1024x1_1024x1_1023x24_1023x8_1023x17)
{
    this->Launch<uint32_t, float, 1024, 1, 1024, 1, 1023, 24, 1023, 8, 1023, 17>();
}
TEST_F(TROWARGMINTest, case_uint32_float_264x1_264x1_260x64_260x8_260x64)
{
    this->Launch<uint32_t, float, 264, 1, 264, 1, 260, 64, 260, 8, 260, 64>();
}
TEST_F(TROWARGMINTest, case_uint32_float_8x1_8x1_3x4096_3x192_3x4095)
{
    this->Launch<uint32_t, float, 8, 1, 8, 1, 3, 4096, 3, 192, 3, 4095>();
}
TEST_F(TROWARGMINTest, case_uint32_float_8x1_8x1_1x16384_1x768_1x16381)
{
    this->Launch<uint32_t, float, 8, 1, 8, 1, 1, 16384, 1, 768, 1, 16381>();
}
TEST_F(TROWARGMINTest, case_uint16_half_272x1_272x1_260x64_260x16_260x63)
{
    this->Launch<uint16_t, aclFloat16, 272, 1, 272, 1, 260, 64, 260, 16, 260, 63, true>();
}
TEST_F(TROWARGMINTest, case_uint16_half_272x1_272x1_260x128_260x16_260x127)
{
    this->Launch<uint16_t, aclFloat16, 272, 1, 272, 1, 260, 128, 260, 16, 260, 127, true>();
}
TEST_F(TROWARGMINTest, case_uint16_half_16x1_16x1_3x8192_3x384_3x8191)
{
    this->Launch<uint16_t, aclFloat16, 16, 1, 16, 1, 3, 8192, 3, 384, 3, 8191, true>();
}
TEST_F(TROWARGMINTest, case_uint16_half_16x1_16x1_1x16384_1x768_1x16381)
{
    this->Launch<uint16_t, aclFloat16, 16, 1, 16, 1, 1, 16384, 1, 768, 1, 16381, true>();
}
TEST_F(TROWARGMINTest, case_uint16_half_16x1_16x1_1x32768_1x768_1x32761)
{
    this->Launch<uint16_t, aclFloat16, 16, 1, 16, 1, 1, 32768, 1, 768, 1, 32761, true>();
}
TEST_F(TROWARGMINTest, case_uint32_float_777x8_777x8_777x24_777x8_777x17)
{
    this->Launch<uint32_t, float, 777, 8, 777, 8, 777, 24, 777, 8, 777, 17>();
}
TEST_F(TROWARGMINTest, case_uint32_float_784x1_777x8_777x24_777x8_777x17)
{
    this->Launch<uint32_t, float, 784, 1, 777, 8, 777, 24, 777, 8, 777, 17>();
}
TEST_F(TROWARGMINTest, case_uint32_float_777x8_784x1_777x24_777x8_777x17)
{
    this->Launch<uint32_t, float, 777, 8, 784, 1, 777, 24, 777, 8, 777, 17>();
}
TEST_F(TROWARGMINTest, case_uint32_float_3x8_3x8_3x4096_3x192_3x4095)
{
    this->Launch<uint32_t, float, 3, 8, 3, 8, 3, 4096, 3, 192, 3, 4095>();
}
TEST_F(TROWARGMINTest, case_uint32_float_8x1_3x8_3x4096_3x192_3x4095)
{
    this->Launch<uint32_t, float, 8, 1, 3, 8, 3, 4096, 3, 192, 3, 4095>();
}
TEST_F(TROWARGMINTest, case_uint32_float_3x8_8x1_3x4096_3x192_3x4095)
{
    this->Launch<uint32_t, float, 3, 8, 8, 1, 3, 4096, 3, 192, 3, 4095>();
}
TEST_F(TROWARGMINTest, case_uint16_half_777x16_777x16_777x48_777x16_777x43)
{
    this->Launch<uint16_t, aclFloat16, 777, 16, 777, 16, 777, 48, 777, 16, 777, 43, true>();
}
TEST_F(TROWARGMINTest, case_uint16_half_784x1_777x16_777x48_777x16_777x43)
{
    this->Launch<uint16_t, aclFloat16, 784, 1, 777, 16, 777, 48, 777, 16, 777, 43, true>();
}
TEST_F(TROWARGMINTest, case_uint16_half_777x16_784x1_777x48_777x16_777x43)
{
    this->Launch<uint16_t, aclFloat16, 777, 16, 784, 1, 777, 48, 777, 16, 777, 43, true>();
}
TEST_F(TROWARGMINTest, case_uint16_half_3x16_3x16_3x4096_3x192_3x4095)
{
    this->Launch<uint16_t, aclFloat16, 3, 16, 3, 16, 3, 4096, 3, 192, 3, 4095, true>();
}
TEST_F(TROWARGMINTest, case_uint16_half_16x1_3x16_3x4096_3x192_3x4095)
{
    this->Launch<uint16_t, aclFloat16, 16, 1, 3, 16, 3, 4096, 3, 192, 3, 4095, true>();
}
TEST_F(TROWARGMINTest, case_uint16_half_3x16_16x1_3x4096_3x192_3x4095)
{
    this->Launch<uint16_t, aclFloat16, 3, 16, 16, 1, 3, 4096, 3, 192, 3, 4095, true>();
}
TEST_F(TROWARGMINTest, case_uint16_half_1x16_1x16_1x32768_1x768_1x32761)
{
    this->Launch<uint16_t, aclFloat16, 1, 16, 1, 16, 1, 32768, 1, 768, 1, 32761, true>();
}
TEST_F(TROWARGMINTest, case_uint16_half_16x1_1x16_1x32768_1x768_1x32761)
{
    this->Launch<uint16_t, aclFloat16, 16, 1, 1, 16, 1, 32768, 1, 768, 1, 32761, true>();
}
TEST_F(TROWARGMINTest, case_uint16_half_1x16_16x1_1x32768_1x768_1x32761)
{
