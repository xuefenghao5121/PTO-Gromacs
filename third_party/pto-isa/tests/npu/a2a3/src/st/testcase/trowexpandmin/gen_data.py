...
def gen_golden_data(case_name, param):
    ...
    for i in range(vr):
        for j in range(vc):
            golden[i * vc + j] = np.minimum(input1[i * vc + j], input2[i * src1vc + j % src1vc])
...
if __name__ == "__main__":
    # 用例名称
    case_name_list = [
        "TROWEXPANDMINTest.case1",
        "TROWEXPANDMINTest.case2",
        "TROWEXPANDMINTest.case3",
        "TROWEXPANDMINTest.case4",
        "TROWEXPANDMINTest.case5",
        "TROWEXPANDMINTest.case6",
        "TROWEXPANDMINTest.case7",
        "TROWEXPANDMINTest.case8",
        "TROWEXPANDMINTest.case9",
        "TROWEXPANDMINTest.case10",
        "TROWEXPANDMINTest.case11",
        ...
        "TROWEXPANDMINTest.case19",
        "TROWEXPANDMINTest.case20",
        "TROWEXPANDMINTest.case21",
        "TROWEXPANDMINTest.case22",
    ]

    case_params_list = [
        TRowExpandMin(np.float32, 16, 16, 16, 16, True, False),
        TRowExpandMin(np.float32, 16, 16, 32, 32, True, False),
        TRowExpandMin(np.float16, 16, 16, 16, 16, True, False),
        TRowExpandMin(np.float16, 16, 16, 32, 32, True, False),
        TRowExpandMin(np.float32, 1, 16384, 1, 16384, True, False),
        TRowExpandMin(np.float32, 2048, 1, 2048, 8, True, False),
        TRowExpandMin(np.float32, 16, 16, 16, 16, True, True),
        TRowExpandMin(np.float32, 16, 16, 32, 32, True, True),
        TRowExpandMin(np.float16, 16, 16, 16, 16, True, True),
        TRowExpandMin(np.float16, 16, 16, 32, 32, True, True),
        TRowExpandMin(np.float32, 1, 16384, 1, 16384, True, True),
        ...
        TRowExpandMin(np.float32, 1, 16384, 1, 16384, True, False),
        TRowExpandMin(np.float32, 2048, 1, 2048, 8, True, False),
        TRowExpandMin(np.int32, 16, 16, 16, 16, True, False),
        TRowExpandMin(np.int32, 16, 16, 16, 16, True, True),
        TRowExpandMin(np.int16, 16, 16, 16, 16, True, False),
        TRowExpandMin(np.int16, 16, 16, 16, 16, True, True),
    ]
