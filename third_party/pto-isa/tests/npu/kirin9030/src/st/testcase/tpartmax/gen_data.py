...
def gen_golden_data_tpartmax(case_name, param):
    ...
    pad_value = {
        ...
        np.uint8: np.iinfo(np.uint8).min,
        np.int8: np.iinfo(np.int8).min,
        np.uint16: np.iinfo(np.uint16).min,
...
if __name__ == "__main__":
    ...
    case_params_list = [
        ...
        TPartMaxParams(np.float32, 61, 123, 52, 123, 61, 110),
        TPartMaxParams(np.float16, 61, 123, 52, 123, 61, 110),
        TPartMaxParams(np.int8, 61, 123, 52, 123, 61, 110),
        TPartMaxParams(np.int16, 61, 123, 52, 123, 61, 110),
        TPartMaxParams(np.int32, 61, 123, 52, 123, 61, 110),
        TPartMaxParams(np.uint8, 61, 123, 52, 123, 61, 110),
        TPartMaxParams(np.uint16, 61, 123, 52, 123, 61, 110),
        TPartMaxParams(np.uint32, 61, 123, 52, 123, 61, 110),
