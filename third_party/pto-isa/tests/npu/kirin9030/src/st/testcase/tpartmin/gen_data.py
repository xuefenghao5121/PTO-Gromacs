...
if __name__ == "__main__":
    ...
    case_params_list = [
        ...
        TPartMinParams(np.float32, 61, 123, 52, 123, 61, 110),
        TPartMinParams(np.float16, 61, 123, 52, 123, 61, 110),
        TPartMinParams(np.int8, 61, 123, 52, 123, 61, 110),
        TPartMinParams(np.int16, 61, 123, 52, 123, 61, 110),
        TPartMinParams(np.int32, 61, 123, 52, 123, 61, 110),
        TPartMinParams(np.uint8, 61, 123, 52, 123, 61, 110),
        TPartMinParams(np.uint16, 61, 123, 52, 123, 61, 110),
        TPartMinParams(np.uint32, 61, 123, 52, 123, 61, 110),
