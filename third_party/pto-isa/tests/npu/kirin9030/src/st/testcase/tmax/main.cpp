...
void test_tmax()
{
    ...
    if constexpr (isHalf) {
        LaunchTMaxHalf<dstTileH, dstTileW, src0TileH, src0TileW, src1TileH, src1TileW, vRows, vCols, sameTile>(
            dstDevice, src0Device, src1Device, stream);
    } else {
        LaunchTMax<T, dstTileH, dstTileW, src0TileH, src0TileW, src1TileH, src1TileW, vRows, vCols, sameTile>(
            dstDevice, src0Device, src1Device, stream);
    }
...
TEST_F(TMAXTest, case_half_16x64_16x128_16x128_16x64)
{
