...
void test_tsub()
{
    ...
    if constexpr (isHalf) {
        LaunchTSubHalf<dstTileH, dstTileW, src0TileH, src0TileW, src1TileH, src1TileW, vRows, vCols, sameTile>(
            dstDevice, src0Device, src1Device, stream);
    } else {
        LaunchTSub<T, dstTileH, dstTileW, src0TileH, src0TileW, src1TileH, src1TileW, vRows, vCols, sameTile>(
            dstDevice, src0Device, src1Device, stream);
    }
...
TEST_F(TSUBTest, case_half_16x64_16x128_16x128_16x64)
{
