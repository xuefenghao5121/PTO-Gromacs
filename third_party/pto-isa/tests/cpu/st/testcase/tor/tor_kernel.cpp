...
template void LaunchTOR<int16_t, NUM_64, NUM_64, NUM_64, NUM_64>(int16_t *out, int16_t *src0, int16_t *src1,
                                                                 void *stream);
template void LaunchTOR<int32_t, NUM_16, NUM_256, NUM_16, NUM_256>(int32_t *out, int32_t *src0, int32_t *src1,
                                                                   void *stream);
