...
class TGET_ASYNC_Test : public testing::Test {
protected:
    void SetUp() override
    {}
...
TEST_F(TGET_ASYNC_Test, case_float_64x64)
{
    test_tget_async<float, 64, 64>();
}
TEST_F(TGET_ASYNC_Test, case_int32_64x64)
{
    test_tget_async<int32_t, 64, 64>();
}
TEST_F(TGET_ASYNC_Test, case_int16_64x64)
{
    test_tget_async<int16_t, 64, 64>();
}
TEST_F(TGET_ASYNC_Test, case_half_16x256)
{
    test_tget_async<aclFloat16, 16, 256>();
}