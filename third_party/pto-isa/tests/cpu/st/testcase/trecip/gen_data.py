...
def gen_golden_data_trecip(case_name, param):
    dtype = param.dtype
...
if __name__ == "__main__":
    ...
    case_params_list = [
        TRecipParams(np.float32, 64, 64, 64, 64, 64, 64),
        TRecipParams(np.int32, 64, 64, 64, 64, 64, 64),
    ...
    for i, param in enumerate(case_params_list):
        ...
        os.chdir(case_name)
        gen_golden_data_trecip(case_name, param)
