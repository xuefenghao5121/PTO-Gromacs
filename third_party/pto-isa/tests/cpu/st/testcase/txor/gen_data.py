...
def gen_golden_data_txor(case_name, param):
    dtype = param.dtype
...
def generate_case_name(param):
    ...
    name = f"TXORTest.case_{dtype_str}" 
...
if __name__ == "__main__":
    ...
    case_params_list = [
        TXORParams(np.int16, 64, 64, 64, 64, 64, 64),
        TXORParams(np.int32, 16, 256, 16, 256, 16, 256)
    ]
    ...
    for i, param in enumerate(case_params_list):
        ...
        os.chdir(case_name)
        gen_golden_data_txor(case_name, param)
