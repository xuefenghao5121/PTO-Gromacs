...
void launchTSubsc_demo(uint8_t *out, uint8_t *src, void *stream);

class TSUBSCTest : public testing::Test {
protected:
    void SetUp() override
    {}
...
void test_tsubsc()
{
    ...
    LaunchTSubsc<T, kGRows_, kGCols_, kTRows_, kTCols_>(dstDevice, src0Device, scalarDevice, src1Device, stream);
