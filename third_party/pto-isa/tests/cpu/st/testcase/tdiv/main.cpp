...
void test_tdiv()
{
    ...
    LaunchTDiv<T, kGRows_, kGCols_, kTRows_, kTCols_>(dstDevice, src0Device, src1Device, stream);
...
TEST_F(TDIVTest, case_bf16_16x256_16x256_16x256)
{
    test_tdiv<bfloat16_t, 16, 256, 16, 256>();
}
#endif
